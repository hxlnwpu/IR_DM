...
public class LuceneVSM {
	public static void main(String[] args) throws Exception{ 
		
		//建立索引
		// 创建Directory ：决定索引创建在内存中还是硬盘中
        Directory directory = FSDirectory.open(Paths.get("F:\\Workspace\\Eclipse\\Java\\LuceneVSM\\index"));
        // 创建IndexWriter:写索引
        ...
        try
        {
            ...
            File file = new File("F:\\Workspace\\Eclipse\\Java\\LuceneVSM\\test");
        ...
        {
            // 1.创建Directory
            Directory Sdirectory = FSDirectory.open(Paths.get("F:\\Workspace\\Eclipse\\Java\\LuceneVSM\\index"));
            // 2.创建IndexReader
